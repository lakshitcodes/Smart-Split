...
export const TESTIMONIALS = [
    {
        quote:
            "Ye babu rao ka style hai! With SmartSplit, I finally stopped getting confused about who paid for what!",
        name: "Babu Rao",
    ...
    {
        quote:
            "SmartSplit's calculations are so accurate, they're even better than my scheme to double money in 25 days!",
        name: "Raju",
    ...
    {
        quote:
            "If that I have SmartSplit, Raju wont get away with selling my shoes and coat! I'll add to his debt!",
        name: "Shyam",
