...
const iosImages = imgNames.map((n) => ({
  src: `/install-dir/android/${n}`,
  alt: `iOS step ${n}`,
    ...
    <section className="min-h-screen py-8 px-4 md:pt-24">
      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-8 text-center">
          <h2 className="text-3xl md:text-4xl font-extrabold gradient-title">
          ...
          <Tabs defaultValue="android" className="w-full">
            <div className="max-w-md mx-auto mb-6">
              <TabsList className="grid grid-cols-2 gap-2">
                ...
                >
                  <Chrome className="h-4 w-4" /> Android (Chrome)
                </TabsTrigger>
                <TabsTrigger
                  value="ios"
                  className="flex items-center justify-center gap-2"
      ...
      <div className="flex flex-col md:grid md:grid-cols-5 gap-4">
        <div className="md:col-span-3">
          <div className="relative md:px-15">
            ...
            className="w-full overflow-x-auto scroll-smooth snap-x snap-mandatory flex gap-6 py-6 px-4 rounded-2xl"
                ...
                <ol className="list-decimal list-inside space-y-3 text-sm">
                  {steps.map((s, i) => (
                    <li
                      key={i}
                      onClick={() => goTo(i)}
                      className={`p-2 rounded-md cursor-pointer transition-colors ${active === i ? "bg-white/10 border border-white/20" : "hover:bg-white/5"}`}
                    >
